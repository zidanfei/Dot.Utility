...
namespace Dot.Adapter.Tests
{
    ...
    public class DotProfiles : AutoMapper.Profile
    {
        protected override void Configure()
        { 
            //DataDictTypes => DataDictTypesDto
            var DataDictTypesMappingExpression = Mapper.CreateMap<DomainModelTest, DTOModelTest>();
            //DataDictTypesMappingExpression.ForMember(dto => dto.DataDictTypeId, mc => mc.MapFrom(e => e.Id));

            //DataDictTypesDto => DataDictTypes
            var DataDictTypesDtoMappingExpression = Mapper.CreateMap<DTOModelTest, DomainModelTest>();
