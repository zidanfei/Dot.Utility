<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demo1.aspx.cs" Inherits="ueditor.demo1" validateRequest="false" %>
...
<body>
    <div>
        ...
        <form method="post" action="demo1.aspx" runat="server">
    ...
    <script type="text/javascript">
        ...
        UE.getEditor('editor').execCommand('insertHtml', "fdsafdsfd")
