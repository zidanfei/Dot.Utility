...
namespace Dot.Utility
{
    public class ChineseToPinYin
    {
        ...
        private static Dictionary<string, string> _Phrase;

        /// <summary>
        /// 设置或获取包含列外词组读音的键/值对的组合。
        /// </summary>
        public static Dictionary<string, string> Phrase
        {
            get
            {
                if (_Phrase == null)
                {
                    _Phrase = new Dictionary<string, string>();
                }
                return _Phrase;
            }
            set { _Phrase = value; }
