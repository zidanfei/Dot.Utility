...
namespace Dot.Utility.Memcached
{
    ...
    {
        // logger
        private static ILog Log = LogFactory.RunningLog;
		...
		private static ResourceManager _resourceManager = new ResourceManager("Dot.Utility.Memcached.StringMessages", typeof(SockIOPool).Assembly);
