...
namespace Dot.Utility.Memcached
{
	...
	public class MemcachedClient 
	{
		...
		// logger
		private static ILog log = Log.LogFactory.RunningLog;
		...
		private static ResourceManager _resourceManager = new ResourceManager("Dot.Utility.Memcached.StringMessages", typeof(MemcachedClient).Assembly);
