...
namespace Dot.Utility.Data
{
    ...
    public sealed class SQLiteHelper
    {
        ...
        /// <summary> 
        /// 将DataRow类型的列值分配到SQLiteParameter参数数组. 
        /// </summary> 
        ...
        /// <summary> 
        /// 执行指定连接字符串,类型的SQLiteCommand.如果没有提供参数,不返回结果. 
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ...
        /// <param name="commandType">命令类型 (存储过程,命令文本, 其它.)</param> 
        /// <param name="commandText">存储过程名称或SQL语句</param> 
        /// <param name="commandParameters">SQLiteParameter参数数组</param> 
        /// <returns>返回命令影响的行数</returns> 
        ...
        /// <param name="commandType">命令类型 (存储过程,命令文本或其它)</param> 
        /// <param name="commandText">存储过程名或T-SQL语句</param> 
        /// <param name="commandParameters">SQLiteParameters参数数组,如果没有参数则为'null'</param> 
        /// <param name="connectionOwnership">标识数据库连接对象是由调用者提供还是由SqlHelper提供</param> 
        /// <returns>返回包含结果集的SQLiteDataReader</returns> 
        ...
        /// <param name="commandType">命令类型 (存储过程,命令文本或其它)</param> 
        /// <param name="commandText">存储过程名或T-SQL语句</param> 
        /// <param name="commandParameters">SqlParamter参数数组(new SQLiteParameter("@prodid", 24))</param> 
        /// <returns>返回包含结果集的SQLiteDataReader</returns> 
        ...
        /// <summary> 
        /// [私有方法][内部调用]执行指定数据库连接对象/事务的命令,映射数据表并填充数据集,DataSet/TableNames/SQLiteParameters. 
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ...
        #region CreateCommand 创建一条SQLiteCommand命令
        /// <summary> 
        /// 创建SQLiteCommand命令,指定数据库连接对象,存储过程名和参数. 
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ...
        /// <returns>返回SQLiteCommand命令</returns> 
    ...
    /// <summary> 
    /// SQLiteHelperParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数. 
    /// </summary> 
    ...
    /// </summary>
    public static class SQLiteHelper1
    {
