...
namespace Dot.Utility.Office
{
    public class ExcelHelper
    {
        ...
        /// <returns></returns>
        public static DataTable ImportExceltoDt(string strFileName, string SheetName, int HeaderRowIndex = 0)
        {
                                ...
                                if (row.GetCell(j) != null)
                                {
                                    switch (row.GetCell(j).CellType)
                                    {
                                        ...
                                        case CellType.Numeric:
                                            if (NPOI.SS.UserModel.DateUtil.IsCellDateFormatted(row.GetCell(j)))
                                            {
