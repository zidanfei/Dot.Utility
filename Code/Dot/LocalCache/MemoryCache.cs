...
namespace Dot.LocalCache
{
    ...
    {
        #region Enumerator classes for the MemoryCache--迭代器实现
        internal class EnumeratorJoiner : EnumeratorJoinerBase, IEnumerator
        {
            internal EnumeratorJoiner(MemoryCache parent, params IEnumerator[] enumerators)
        ...
        internal class DictionaryEnumeratorJoiner : EnumeratorJoinerBase, IDictionaryEnumerator
        {
            ...
            internal DictionaryEnumeratorJoiner(MemoryCache parent, params IDictionaryEnumerator[] enumerators)
                : base(parent.readWriteLock, enumerators)
            {
