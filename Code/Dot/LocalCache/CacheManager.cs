...
namespace Dot.LocalCache
{
    ...
    public class CacheManager
    {
        ...
        {
            return AddContext(context, typeof(MemoryCache));
        }
        ...
        /// <returns>False if the context already exists, true otherwise.</returns>
        /// <exception cref="System.InvalidCastException">Thrown when type 'cacheType' does not implement Dot.LocalCache.ICache</exception>
        ...
        public static bool Remove(string context, object key)
        {
            ...
            try
            {
                if (caches.ContainsKey(context) && caches[context].Contains(key))
                {
        ...
        //public static Dot.LocalCache.Contexts Contexts = new Contexts(ref Cache.caches.Keys);
    }
}
