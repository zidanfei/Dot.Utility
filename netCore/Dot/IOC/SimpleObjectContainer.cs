...
namespace Dot.IOC
{
    internal class SimpleObjectContainer : IObjectContainer
    {
        ...
        private readonly static Dictionary<Type, Dictionary<string, Type>> _types = new Dictionary<Type, Dictionary<string, Type>>();
        private readonly static Dictionary<Type, Dictionary<string, object>> _instances = new Dictionary<Type, Dictionary<string, object>>();
